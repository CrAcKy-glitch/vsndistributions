  ...
  const regions = [
    {
      region: "Middle East",
      description:
        "Headquartered in Dubai with operations across the GCC region",
      stats: "",
    },
    {
      region: "Africa",
      description:
        "Strong presence in West Africa with distribution hub in Lagos, Nigeria",
      stats: "",
    },
    {
      region: "CIS Region",
      description:
        "Deep market expertise spanning former Soviet republics and emerging economies",
      stats: "",
    },
  ];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed font-light">
            Operating across 50+ countries with strategic hubs in key markets,
            we're positioned to serve you wherever you are.
          </p>
        </div>
        ...
        <div className="mt-20 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl border border-slate-700 p-12 text-center">
          ...
          <p className="text-slate-400 mt-6">
            From Middle East hubs to African markets, serving the CIS region
            with excellence
          </p>
        </div>
      </div>
