      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div ref={contentRef} className="space-y-6">
            <p className="text-sm font-semibold text-cyan-600 tracking-widest uppercase">
              Founded 2013
            </p>
            <h2 className="text-5xl md:text-6xl font-black text-slate-900 leading-tight">
              Building Trust,{" "}
              <span className="text-cyan-600">One Partnership</span> at a Time
            </h2>
            <p className="text-lg text-slate-700 leading-relaxed font-light">
              Founded in 2013, VSN Group emerged from a vision to revolutionize
              electronics distribution across emerging markets. What started as
              a bold idea in Dubai has grown into a formidable force connecting
              premium brands with retailers and distributors across three
              continents.
            </p>
            <p className="text-lg text-slate-700 leading-relaxed font-light">
              Driven by a passion to connect customers with cutting-edge
              technology and world- class products, VSN Group isn’t just meeting
              industry standards — we’re setting them.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            >
              <div className="text-4xl font-black text-cyan-600 mb-2">3</div>
              <p className="text-sm font-semibold text-slate-900">
                Key Regions
              </p>
